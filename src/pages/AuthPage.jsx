...
const PortalToggle = ({ portal, onChange }) => (
  <div className="relative flex bg-gray-100 rounded-2xl p-1 mb-6">
    <div
      ...
      style={{
        width: 'calc(50% - 4px)',
        left: portal === 'medico' ? 'calc(50%)' : '4px',
    ...
    <button
      ...
      className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-medium relative z-10 cursor-pointer transition-colors duration-200 ${
